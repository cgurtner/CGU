...
<head>
    ...
    <link rel="stylesheet" href="/gui/css/web-1.0.3.css">
...
<script type="application/ld+json"><?php include_once('./file/google/person.json'); ?></script>
...
<script src="/gui/js/web-1.0.1.js"></script>
</body>
</html><?php
